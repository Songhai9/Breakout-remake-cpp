...
SDL_Color Brick::getColor() const {
    switch (hitPoints) {
        case 3: return { 0x33, 0x33, 0x33, 0xFF }; // Darker shade for 3-hit bricks
        case 2: return { 0x66, 0x66, 0x66, 0xFF }; // Medium shade for 2-hit bricks
        case 1: return { 0x99, 0x99, 0x99, 0xFF }; // Lighter shade for 1-hit bricks
        default: return { 0x00, 0xFF, 0x00, 0xFF }; // Default color (green)
    }
}
